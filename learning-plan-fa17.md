...
| Week 7 | Learning Activity 6 plus Q&A | ZOOM VIDEO Introduction to BLOG 5, Book Development Review plus Q&A | **June 11, 2018 - 6 pm - 7 pm PDT** - _\(optional F2F interaction can be arranged for those living within driving distance to the univeristy\)  _       The session will be recorded _ _and distributed for those unable to connect directly to the session. |
